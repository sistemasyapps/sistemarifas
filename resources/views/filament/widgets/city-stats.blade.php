<x-filament-widgets::widget>
    <x-filament::section>
        <div style="height: 300px; overflow: auto;">
            <h3 class="text-lg font-bold mb-4">Ordenes por Ciudad</h3>
            <table class="table-fixed w-full">
                <thead>
                    <tr>
                        <!-- <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase">Pais</th> -->
                        <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase">Región</th>
                        <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase">Ciudad</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($data as $row)
                        <tr>
                            ...
                            <td class="px-6 py-4">{{ $row->ordenes }}</td>
                        </tr>
                    @endforeach
                </tbody>
