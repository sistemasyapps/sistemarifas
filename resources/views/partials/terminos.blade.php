    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background: black;">
            ...
            <div class="modal-body" style="font-size: 14px">
                ...
                <p>4.- La compra mínima requerida para participar en nuestros sorteos es de dos tickets. Los tickets serán asignados de manera aleatoria y los recibirás a través del correo electrónico proporcionado.</p>
                <p>5.- Para reclamar tu premio tienes un lapso de 72 horas.</p>
                <p>6.- Los ganadores aceptan aparecer en el contenido audiovisual del sorteo mostrando su presencia en las redes y entrega de los premios. Esto es OBLIGATORIO.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" style="background-color: #2a1d5e!important; border-color: #2a1d5e;" data-bs-dismiss="modal">Aceptar</button>
            </div>
        </div>
    </div>
</div>